...
from Mafia.modules.play import generate_cover
from Mafia.modules.play import arq
from Mafia.modules.play import cb_admin_check
from Mafia.modules.play import transcode
from Mafia.modules.play import convert_seconds
from Mafia.modules.play import time_to_seconds
...
from Mafia.helpers.channelmusic import get_chat_id
from Mafia.helpers.decorators import authorized_users_only
from Mafia.helpers.filters import command, other_filters
from Mafia.helpers.gets import get_file_name
from Mafia.services.callsmusic import callsmusic, queues
from Mafia.services.callsmusic.callsmusic import client as USER
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @mafia_music_player to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
